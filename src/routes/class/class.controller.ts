...
class ClassController {
    ...
    async getClassMember(input: GetClassMemberInput): Promise<GetClassMemberResponse> {
    ...
    async getClassListByUser(input: GetClassListByUserInput): Promise<GetClassListResponse> {
        ...
        const nextCall = await this.classService.getClassListByUser({ ...input, cursor });
